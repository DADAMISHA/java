...
let s = 'ldfksfgvxykvfm'
     ...
     /*/найти количество чисел в массиве, которые деляться на 3,но не деляться на 7.
     let arr = []
...
let arr = [1, 3, 5, 3452354, 233, 234, 1];
     ...
     console.log(max);*/
/*/найти сумму максимальной и минимальной
let arr = [1, 3, 5, 3452354, 233, 234, 1];
     let max = arr.pop();
     let min = max;
     for(let i=0; i< arr.length; i++){
...
console.log(max+min);*/
/*/в данной строке гайти сумму цифр.
let str = 'siovjiewf123413423453jhcvscev'
let a =str.split('');
let s = 0;
...
/*let arr = [1.82, 7.43, 4.84, 0.72];
arr.forEach((e) => {result.push(e*2)})
let result = arr.map( (e) => e*2)
console.log(result);*/
/*let arr = [1.81, 7.43, 4.84, 0.72, 2.89];
...
let a = (previousValue, currentValue) => previousValue + currentValue;
let q = arr.reduce(a);
console.log(q);
let b = q / arr.length
console.log(b);
let w = arr.filter(n=> n>b)
console.log(w);*/
